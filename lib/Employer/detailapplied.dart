...
class Detailapplied extends StatelessWidget {
  Detailapplied( {Key key, this.freelancer}) : super(key: key);
 ...
 /* Future getinfos() async {
    ...
    http.get(GeneralAdresse().Gadress + "/profiles/getemployerinfos.php?id="+id.toString(),headers: {"content-type": "application/json"}).then((http.Response response) {
 ...
 /* final String _fullName = "Nick Frost";
  ...
  Widget _buildGetInTouch(BuildContext context) {
    return Container(
      ...
      child: Text(
        "Get in Touch with ${freelancer['name'].split(" ")[0]},",
