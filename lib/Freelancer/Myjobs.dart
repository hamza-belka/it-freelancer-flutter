...
class Myjobs extends StatefulWidget {
  Myjobs({Key key, this.title}) : super(key: key);

  final String title;


  @override
  _MyjobsState createState() =>
...
class _MyjobsState extends State<Myjobs> {
  ...
  void initState() {
    ...
    http.get(GeneralAdresse().Gadress + "/jobs/appliedjobs.php?id=4",headers: {"content-type": "application/json"}).then((http.Response response) {
