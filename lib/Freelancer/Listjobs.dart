...
import 'package:itfreelance/Freelancer/Freejobdetails.dart';
...
class Listjobs extends StatefulWidget {
  Listjobs({Key key, this.title}) : super(key: key);

  final String title;


  @override
  _ListjobsState createState() =>
...
class _ListjobsState extends State<Listjobs> {
  ...
  void initState() {
    ...
    http.get(GeneralAdresse().Gadress + "/jobs/listjobs.php?id=4",headers: {"content-type": "application/json"}).then((http.Response response) {
                ...
                onPressed:(){
                  Navigator.push(
                      ...
                      MaterialPageRoute(builder: (context) {
                        ...
                        return new Freejobdetails(index:myjobs[index]['jobid']);})
                  );
