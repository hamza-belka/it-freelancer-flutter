...
import 'package:itfreelance/Freelancer/Listjobs.dart';
import 'package:itfreelance/Freelancer/Myjobs.dart';
...
class Dashbordfree extends StatefulWidget {


  Dashbordfree({Key key, this.value}) : super(key: key);
  final int value;
  ...
  @override
  _DashbordfreeState createState() => _DashbordfreeState();
...
class _DashbordfreeState extends State<Dashbordfree> {
  List<job> jobs = [];
